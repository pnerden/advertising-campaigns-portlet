 ...
 */
public class CampaignLogServiceClp implements CampaignLogService {
	public CampaignLogServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "markDisplayed";

		_methodParameterTypes3 = new String[] { "long" };

		_methodName4 = "clearCampaign";
	...
	public void markDisplayed(long campaignId)
		...
		try {
			_invokableService.invokeMethod(_methodName3,
				_methodParameterTypes3, new Object[] { campaignId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public void clearCampaign(long companyId, long campaignId)
		...
		try {
			_invokableService.invokeMethod(_methodName4,
				_methodParameterTypes4, new Object[] { companyId, campaignId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
