...
/**
 * The utility for the campaign local service. This utility wraps {@link org.lsp.liferay.portlet.advertising.service.impl.CampaignLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see org.lsp.liferay.portlet.advertising.service.impl.CampaignLocalServiceImpl
 * @generated
 */
public class CampaignLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link org.lsp.liferay.portlet.advertising.service.impl.CampaignLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static org.lsp.liferay.portlet.advertising.model.Campaign addCampaign(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.lsp.liferay.portlet.advertising.model.Campaign deleteCampaign(
		long campaignId)
	...
	*/
	...
	public static org.lsp.liferay.portlet.advertising.model.Campaign fetchCampaign(
		long campaignId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static long getCampaignIdToDisplay(long companyId, long userId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getCampaignIdToDisplay(companyId, userId);
	}
	...
	public static org.lsp.liferay.portlet.advertising.model.Campaign createCampaign(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .createCampaign(companyId, journalArticlePrimaryKey,
			beginDate, endDate);
	}
	...
	public static org.lsp.liferay.portlet.advertising.model.Campaign getCampaign(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCampaign(companyId, campaignId);
	}

	public static java.util.List<org.lsp.liferay.portlet.advertising.model.Campaign> getCampaigns(
		long companyId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCampaigns(companyId);
	}
	...
	public static org.lsp.liferay.portlet.advertising.model.Campaign updateCampaign(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateCampaign(campaignId, companyId,
	...
	public static long removeCampaign(long companyId, long campaignId)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.lsp.liferay.portlet.advertising.NoSuchCampaignException {
		return getService().removeCampaign(companyId, campaignId);
	}

	public static org.lsp.liferay.portlet.advertising.model.Campaign startCampaign(
		long companyId, long campaignId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().startCampaign(companyId, campaignId);
	}

	public static org.lsp.liferay.portlet.advertising.model.Campaign pauseCampaign(
		long companyId, long campaignId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().pauseCampaign(companyId, campaignId);
	}

	public static org.lsp.liferay.portlet.advertising.model.Campaign stopCampaign(
		long companyId, long campaignId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().stopCampaign(companyId, campaignId);
	}

	public static org.lsp.liferay.portlet.advertising.model.Campaign activate(
		long companyId, long campaignId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().activate(companyId, campaignId);
	}

	public static org.lsp.liferay.portlet.advertising.model.Campaign disactivate(
		long companyId, long campaignId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().disactivate(companyId, campaignId);
	}
