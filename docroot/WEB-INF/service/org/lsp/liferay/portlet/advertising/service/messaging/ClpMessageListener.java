...
package org.lsp.liferay.portlet.advertising.service.messaging;
...
import org.lsp.liferay.portlet.advertising.service.ClpSerializer;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			CampaignLogLocalServiceUtil.clearService();

			CampaignLogServiceUtil.clearService();
		}
	}
}